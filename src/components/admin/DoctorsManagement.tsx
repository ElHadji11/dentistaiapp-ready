...
import { EditIcon, MailIcon, PhoneIcon, PlusIcon, StethoscopeIcon, Trash } from "lucide-react";
...
function DoctorsManagement() {
    ...
    return (
        <>
                            ...
                            >
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <Button
                                        ...
                                        disabled={doctorToDelete?.id === doctor.id && deleteDoctorMutation.isPending}
                                    >
                                        <Trash className="size-4 mr-1" />
                                        {doctorToDelete?.id === doctor.id && deleteDoctorMutation.isPending ? "Deleting..." : "Delete"}
                                    </Button>
            ...
            <AlertDialog open={!!doctorToDelete} onOpenChange={(open) => !open && closeDeleteDialog()}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>Are you sure you want to delete Dr. {doctorToDelete?.name}?</AlertDialogTitle>
                        <AlertDialogDescription>
                    ...
                    <AlertDialogFooter>
                        ...
                        >
                            {deleteDoctorMutation.isPending ? "Deleting..." : "Continue"}
                        </AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
            </AlertDialog>
